...
3. Adjust from the base rate in the direction the evidence points. Strong evidence = large adjustment. Weak or mixed evidence = stay near the base rate.
...
- If market price is above 0.85 or below 0.15 and your analysis agrees, output at least 0.90 or at most 0.10.
